...
import { postArticulo, putArticulo } from './services/ArticuloServices';
...
const FormArticulos = ({traerArticulo, articuloEditar}) => {
     ...
     const handleSubmit = (e) =>{
       ...
       if(modo === "crear"){
        Swal.fire({
         ...
         Swal.fire({
           title: "¿Editar?",
           text:"Seguro que sea editar el registro del articulo",
           icon: "question",
           showCancelButton: true
         }).then((isConfirmed) => {
            if(isConfirmed){
              putArticulo({...formulario}).then((respuesta) =>{
        ...
        ​              <div className="form-group col-md-6"> 
                        ...
                        <div className="form-group col-md-6">
                            <button className="btn btn-block btn-primary" type="submit">
                              {modo === "crear"? "Registrar Articulo" : "Guardar Cambios"}
                              </button>
                            </div>
                        <div className="form-group col-md-6">
